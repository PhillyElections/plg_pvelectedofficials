        ...
        foreach ($results as $label => $group) {
            ...
            foreach ($group as $items) {
                foreach ($items as $item) {
                    ...
                    if ($item['website']) {
                        $return .= '		<a class="p-name u-url" href="' . $item['website'] . '" target="_blank">' . $fullname . '</a> <sup class="p-note" title="' . (strtoupper($item['party']) === 'D' ? 'Democratic' : 'Republican') . '">' . strtoupper($item['party']) . '</sup>';
                    } else {
